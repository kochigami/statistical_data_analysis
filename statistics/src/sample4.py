...
(difference_of_others / (total_num - (condition_number_of_factor1 - 1) - (len(label) - condition_number_of_factor1 -1) -1)))],
                    ["Others", str(difference_of_others), str(total_num -1 -1 -1 -1), str(difference_of_others / (total_num - (condition_number_of_factor1 - 1) - (len(label) - condition_number_of_factor1 -1) -1)), ""],
