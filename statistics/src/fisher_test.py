...
class FisherTest:   
    def test(self, data):
        ...
        data[3] = d
        """
        # check data length is 4
        if len(data) == 4 and isinstance(data[0], list) == False and isinstance(data[1], list) == False and isinstance(data[2], list) == False and isinstance(data[3], list) == False:
            a = data[0]
            b = data[1]
            c = data[2]
            d = data[3]
