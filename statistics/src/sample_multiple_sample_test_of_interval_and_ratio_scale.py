...
if __name__ == '__main__':
    ...
    if args[1] == "1":
        ...
        data['Box-Order'] = [70, 80, 75, 75, 95, 80, 75, 55, 50, 85, 80, 70, 75, 80, 60]
        data['Paper-Tsukurioki'] = [50, 55, 70, 75, 80, 85, 65, 55, 55, 75, 80, 75, 70, 65, 55]
        data['Paper-Order'] = [60, 65, 75, 80, 90, 80, 80, 55, 60, 82, 80, 70, 90, 70, 60]
        label_a = ["Box", "Paper"]
