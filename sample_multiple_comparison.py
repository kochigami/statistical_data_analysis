...
if __name__ == '__main__':
    ...
    if len(args) is not 2:
        ...
        print "1: chi-square test => chi-square test"
        print "2: Cochran's Q test => mcnemar test"
        print "3: kruskal-wallis test => mann-whitney test"
        print "4: friedman test => signed test"
    else:
        data = OrderedDict()
        if args[1] == "1":
            data["A"] = [12, 10, 8]
